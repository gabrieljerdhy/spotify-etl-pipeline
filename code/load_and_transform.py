...
def lambda_handler(event, context):
    ...
    for data in spotify_data:
        ...
        songs_key = (
            "transformed_data/songs_data/song_transformed_"
            + str(datetime.now())
            + ".csv"
        )
        ...
        album_key = (
            "transformed_data/album_data/album_transformed_"
            + str(datetime.now())
            + ".csv"
        )
        ...
        artist_key = (
            "transformed_data/artist_data/artist_transformed_"
            + str(datetime.now())
            + ".csv"
        )
    ...
    for key in spotify_keys:
        ...
        s3_resource.meta.client.copy(
            copy_source, Bucket, "raw_data/proccessed/" + key.split("/")[-1]
        )
